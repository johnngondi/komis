								...
								<div class="col-md-12 col-sm-12">
									...
									<div class="panel-body">
										...
										<div class="col-md-5 col-sm-12 centering">
											<form action="upload.php?idno=<?=$_SESSION['staffid']?>&&src=dochome&&user=staff" method="post" enctype="multipart/form-data">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-6 col-xsm-12 parent">
								<a href="diagnose.php"><div class="contents-invert">
